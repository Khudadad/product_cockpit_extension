...
/**
 * This is the extension manager of the testcockpit extension.
 */
public class TestcockpitManager extends GeneratedTestcockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(TestcockpitManager.class.getName());
	 ...
	 */
	public static final TestcockpitManager getInstance()
	{
		return (TestcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TestcockpitConstants.EXTENSIONNAME);
	}
